    ...
    */
    'stubs' => [
        ...
        'files' => [
            ...
            'controller/controller' => 'Http/Controllers/$STUDLY_NAME$Controller.php',
            'view/index.vue' => 'resources/views/index.vue',
            'view/create.vue' => 'resources/views/create.vue',
            'view/edit.vue' => 'resources/views/edit.vue',
            'view/show.vue' => 'resources/views/show.vue',
            'scaffold/config' => 'config/config.php',
            'module/composer.json' => 'composer.json',
        ],
        'replacements' => [
            'route/web' => ['LOWER_NAME', 'STUDLY_NAME', 'PLURAL_LOWER_NAME', 'KEBAB_NAME', 'MODULE_NAMESPACE', 'CONTROLLER_NAMESPACE'],
            'route/api' => ['LOWER_NAME', 'STUDLY_NAME', 'PLURAL_LOWER_NAME', 'KEBAB_NAME', 'MODULE_NAMESPACE', 'CONTROLLER_NAMESPACE'],
            'controller/controller' => ['CLASS_NAMESPACE', 'CLASS', 'MODULE', 'MODEL_NAMESPACE', 'MODEL', 'LOWER_NAME', 'TABLE_NAME'],
            'json' => ['LOWER_NAME', 'STUDLY_NAME', 'KEBAB_NAME', 'MODULE_NAMESPACE', 'PROVIDER_NAMESPACE'],
            'view/index.vue' => ['LOWER_NAME', 'STUDLY_NAME'],
            'view/create.vue' => ['LOWER_NAME', 'STUDLY_NAME'],
            'view/edit.vue' => ['LOWER_NAME', 'STUDLY_NAME'],
            'view/show.vue' => ['LOWER_NAME', 'STUDLY_NAME'],
